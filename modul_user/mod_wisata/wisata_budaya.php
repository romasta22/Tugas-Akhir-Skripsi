...
// id_kategori untuk wisata Budaya
$id_kategori = 2;
...
<body>
    <div class="container py-5">
        <h1 class="text-center mb-3">Daftar Wisata Budaya</h1>
        <p class="text-center">"Temukan Cerita di Balik Budaya Lokal, Gak Bakal Nyesel!"</p>
        <!-- Form pencarian -->
        <form method="GET" action="" class="mb-4">
            <input type="hidden" name="hal" value="wisata_budaya">
            ...
            if ($result->num_rows > 0) {
                while ($wisata = $result->fetch_assoc()) {
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                        <div class="card">
                            <a href="index_user.php?hal=detail_wisata_budaya&id=<?php echo $wisata['id_wisata']; ?>">
                                <img src="<?php echo $gambar; ?>" class="card-img-top" alt="<?php echo htmlspecialchars($wisata['nama_wisata']); ?>">
                            </a>
                            <div class="card-body">
                                <a href="index_user.php?hal=detail_wisata_budaya&id=<?php echo $wisata['id_wisata']; ?>" class="text-decoration-none">
            ...
            <nav aria-label="Page navigation">
                <ul class="pagination mb-0">
                    ...
                    <li class="page-item <?php echo $currentPage == 1 ? 'disabled' : ''; ?>">
                        <a class="page-link" href="?hal=wisata_budaya&search=<?php echo isset($_GET['search']) ? htmlspecialchars($_GET['search']) : ''; ?>&entriesPerPage=<?php echo $entriesPerPage; ?>&page=1" aria-label="First">
                            <<
                        </a>
                    </li>
                    <!-- Tombol ke halaman sebelumnya -->
                    <li class="page-item <?php echo $currentPage == 1 ? 'disabled' : ''; ?>">
                        <a class="page-link" href="?hal=wisata_budaya&search=<?php echo isset($_GET['search']) ? htmlspecialchars($_GET['search']) : ''; ?>&entriesPerPage=<?php echo $entriesPerPage; ?>&page=<?php echo max(1, $currentPage - 1); ?>" aria-label="Previous">
                            <
                        </a>
                    </li>
                    ...
                    <li class="page-item <?php echo $currentPage == $totalPages ? 'disabled' : ''; ?>">
                        <a class="page-link" href="?hal=wisata_budaya&search=<?php echo isset($_GET['search']) ? htmlspecialchars($_GET['search']) : ''; ?>&entriesPerPage=<?php echo $entriesPerPage; ?>&page=<?php echo min($totalPages, $currentPage + 1); ?>" aria-label="Next">
                            >
                        </a>
                    </li>
                    <!-- Tombol ke halaman terakhir -->
                    <li class="page-item <?php echo $currentPage == $totalPages ? 'disabled' : ''; ?>">
                        <a class="page-link" href="?hal=wisata_budaya&search=<?php echo isset($_GET['search']) ? htmlspecialchars($_GET['search']) : ''; ?>&entriesPerPage=<?php echo $entriesPerPage; ?>&page=<?php echo $totalPages; ?>" aria-label="Last">
                            >>
                        </a>
                    </li>
                </ul>
