...
.star-rating label:hover ~ label {
    color: #ffcc00; /* Hover effect untuk semua bintang sebelumnya */
        ...
        <div class="row d-flex justify-content-center">
            ...
            $stmt_rekomendasi->bind_param("i", $id_wisata);
            ...
            ?>
                <div class="col-md-2 col-6 mb-3">
                    <div class="card shadow-sm border-0 h-100">
                        <a href="index_user.php?hal=detail_wisata_alam&id=<?php echo $row['id_wisata']; ?>" class="text-decoration-none">
                            <img src="././image/<?php echo $row['gambar']; ?>" class="card-img-top rounded" alt="<?php echo $row['nama_wisata']; ?>" style="height: 100px; object-fit: cover;">
                            <div class="card-body p-2 text-center" style="min-height: 80px;">
                            <p class="card-title text-dark fw-bold mb-1" style="font-size: 14px; line-height: 1.4;"><?php echo $row['nama_wisata']; ?></p>
